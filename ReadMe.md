<p align="center">
  <a href="https://github.com/deadlydog/AzureArtifactsPowerShellModuleHelper/actions/workflows/build-and-test-powershell-module.yml"><img alt="Build status" src="https://github.com/deadlydog/AzureArtifactsPowerShellModuleHelper/actions/workflows/build-and-test-powershell-module.yml/badge.svg"></a>
  <a href="https://github.com/deadlydog/AzureArtifactsPowerShellModuleHelper/actions/workflows/build-test-and-deploy-powershell-module.yml"><img alt="Deploy status" src="https://github.com/deadlydog/AzureArtifactsPowerShellModuleHelper/actions/workflows/build-test-and-deploy-powershell-module.yml/badge.svg"></a>
  <a href="https://github.com/deadlydog/AzureArtifactsPowerShellModuleHelper/blob/main/License.md"><img alt="License" src="https://img.shields.io/github/license/deadlydog/AzureArtifactsPowerShellModuleHelper.svg"></a>
  <a href="https://github.com/deadlydog/AzureArtifactsPowerShellModuleHelper/blob/main/docs/Contributing.md"><img alt="PRs welcome" src="https://img.shields.io/badge/PRs-welcome-brightgreen.svg"></a>
</p>

<p align="center">
  <a href="https://www.powershellgallery.com/packages/AzureArtifactsPowerShellModuleHelper"><img alt="Stable PowerShell module version" src="https://img.shields.io/powershellgallery/v/AzureArtifactsPowerShellModuleHelper.svg"></a>
  <a href="https://www.powershellgallery.com/packages/AzureArtifactsPowerShellModuleHelper"><img alt="Prerelease PowerShell module version" src="https://img.shields.io/powershellgallery/vpre/AzureArtifactsPowerShellModuleHelper.svg?include_prereleases&label=powershell%20gallery%20prerelease&colorB=yellow"></a>
  <a href="https://www.powershellgallery.com/packages/AzureArtifactsPowerShellModuleHelper"><img src="https://img.shields.io/powershellgallery/dt/AzureArtifactsPowerShellModuleHelper.svg"></a>
</p>

<p align="center">
  <!-- Must add 'Windows', 'MacOS', and 'Linux' to the module manifest tags for them to show up on the Platforms badge. -->
  <img src="https://img.shields.io/powershellgallery/p/AzureArtifactsPowerShellModuleHelper.svg">
  <img src="https://img.shields.io/github/languages/top/deadlydog/AzureArtifactsPowerShellModuleHelper.svg">
  <img src="https://img.shields.io/github/languages/code-size/deadlydog/AzureArtifactsPowerShellModuleHelper.svg">
</p>
...
```powershell
Install-Module -Name AzureArtifactsPowerShellModuleHelper -Scope CurrentUser -Force -Repository PSGallery -RequiredVersion 2.4.2
```
...
Instead, you can use `-RequiredVersion 2.4.2` (or whatever [the latest stable version is][PowerShellGalleryPackageUrl]) to ensure you don't accidentally download an update with a breaking change.
